...
public class Seguimiento implements Serializable {
    ...
    @SequenceGenerator(name = "SecuenciaSeguimiento", sequenceName = "SEQ_SEGUIMIENTO", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SecuenciaSeguimiento")
