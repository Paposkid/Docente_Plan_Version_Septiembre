...
public class DistribucionActividad implements Serializable {
    ...
    @SequenceGenerator(name = "SecuenciaDistActividad", sequenceName = "SEQ_DIST_ACTIVIDADES", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SecuenciaDistActividad")
